...
export default function Index() {
  ...
  return (
    <div className="flex items-center justify-center h-screen">
      <div className="brightness-25 w-full h-full bg-fixed absolute inset-0 bg-[url('/FondoIndex.webp')] bg-no-repeat blur-sm"
        style={{
      ...
      <div className="absolute z-11 top-0 inset-x-0 justify-center flex items-center h-1/2 mask-center mask-contain mask-[url('/360852603_11441911.png')]">
        <h1 className="text-black text-8xl bg-stone-50 p-[200px] font-serif">Mangify</h1>
      </div>
